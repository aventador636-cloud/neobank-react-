...
export default function Footer() {
  ...
  return (
    <footer style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Container>
        <div style={{ padding: '72px 0 40px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                {socials.map(s => (
                  <a key={s.label} href={s.href} aria-label={s.label} className="footer-social" style={{
          ...
          <div style={{
            ...
            alignItems: 'center', gap: 12, paddingTop: 32,
            borderTop: '1px solid rgba(255,255,255,0.04)',
          }}>
            <p style={{ fontSize: 13, color: t.textTertiary }}>
              © 2026 NeoBank. Лицензия ЦБ РФ №1234.
            </p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
              {['Конфиденциальность', 'Соглашение', 'Реквизиты'].map(l => (
                <a key={l} href="#" style={{
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = t.textSecondary; (e.currentTarget as HTMLElement).style.background = t.surface }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = t.textTertiary; (e.currentTarget as HTMLElement).style.background = 'transparent' }}
                >
                  {l}
                </a>
              ))}
